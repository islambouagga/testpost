...
<div class="wrapper" id="app">
        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <router-link to="/users" class="nav-link ">
                                    <i class="fas fa-users-cog sunflower"></i>
                                    <p>Users</p>
                                </router-link>
                            </li>
                            <li class="nav-item">
                    ...
                    <li class="nav-item has-treeview ">
                        <a href="#" class="nav-link ">
                            <i class="fas fa-store-alt green"></i>
                            <p>
                                Store
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <router-link to="/admin/products" class="nav-link ">
                                    <i class="fab fa-amazon orange"></i>
                                    <p>Products</p>
                                </router-link>
                            </li>
                            <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <router-link to="/admin/orders" class="nav-link">
                            <i class="fa fa-shopping-cart yellow"></i>
                            <p>
                                Orders
                            </p>
                        </router-link>
    ...
    <div class="content-wrapper">
        ...
        <router-link to="/test" class="btn btn-primary">Go to test</router-link>
        <!-- Main content -->
        <div class="content">
